...
- `Docker专题/Docker演练/linux-server-mysql/Dockerfile`
- `Docker专题/Docker演练/linux-server-mysql/docker-compose.yml`
- `Docker专题/Docker演练/linux-server-mysql/.env.example`
- `Docker专题/Docker演练/linux-server-mysql/Docker演练步骤.md`
...
```powershell
scp "E:\本地项目\frontend-knowledge\Docker专题\Docker演练\linux-server-mysql\docker-compose.yml" ubuntu@YOUR_SERVER_IP:/tmp/docker-compose.yml
```
...
```powershell
Copy-Item "E:\本地项目\java-project\linux-server\target\linux-server-0.0.1-SNAPSHOT.jar" "E:\本地项目\frontend-knowledge\Docker专题\Docker演练\linux-server-mysql\linux-server-0.0.1-SNAPSHOT.jar" -Force
```
...
- `Docker专题/Docker演练/linux-server-mysql/.env`
...
```powershell
scp -r "E:\本地项目\frontend-knowledge\Docker专题\Docker演练\linux-server-mysql" ubuntu@YOUR_SERVER_IP:/tmp/
```
