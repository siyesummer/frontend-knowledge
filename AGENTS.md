...
- 当前生产版本为 `v0.9.0`，镜像 `siye-prod-agent:0.9.0`；容器只加入 edge 网络，不发布宿主机 `3002`。生产 Hybrid 索引为 1967 分片，代码围栏内的 `#` 注释不再被误当 Markdown 标题。
